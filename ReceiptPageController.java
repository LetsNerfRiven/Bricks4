...
public class ReceiptPageController implements Initializable{
	...
	public void payment(ActionEvent event){
		...
		alert.setTitle("Order Your Bricks");
		alert.setContentText("Your Order has been Received, Thank You.");
		alert.showAndWait();
	}
	//exits the program after, or before finishing the order 
	@FXML
	...
	public void backBtn(ActionEvent event) throws IOException{
		Parent receiptPage = FXMLLoader.load(getClass().getResource("/bricks4/Main.fxml"));
